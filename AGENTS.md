...
- [2026-09-25] Gemini: Resolução do erro de sincronização FPB no Admin via Cloudflare Pages Function nativa (/api/sync-fpb), múltiplos proxies resilientes com trailing slash e upsert resiliente.
