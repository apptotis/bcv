...
- [2026-05-27] Gemini: Reformulação visual do Admin (admin.html, admin.css) para tema claro (tons de branco), remoção da barra de topo (admin-header), deslocação do botão de logout para o menu esquerdo ao lado de "BCV Admin", e correção da renderização de ícones do FontAwesome.
