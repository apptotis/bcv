document.addEventListener('DOMContentLoaded', () => {
                        ...
                        if (dados.texto && dados.texto.trim() !== '') {
                            ...
                            elTextoContainer.innerHTML = `
                                <div style="background: rgba(126, 34, 206, 0.04); border-left: 4px solid var(--accent-primary); padding: 24px; border-radius: 0 12px 12px 0;">
                                    <p style="font-size: 1.2rem; font-weight: 600; color: var(--accent-primary); margin: 0;">
    ...
    async function loadPatrocinadoresSidebar() {
        try {
            ...
            console.warn("Aviso ao carregar patrocinadores na sidebar:", e);
        }
    }
    loadPatrocinadoresSidebar();
});
