    ...
    async function fetchEquipas() {
        ...
        data.forEach(equipa => {
            ...
            if (equipa.facebook_url) {
                socialIcons += `<a href="${equipa.facebook_url}" target="_blank" class="social-icon facebook-icon" title="Facebook">
            ...
            if (equipa.instagram_url) {
                socialIcons += `<a href="${equipa.instagram_url}" target="_blank" class="social-icon instagram-icon" title="Instagram">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
            ...
            if (equipa.website_url) {
                socialIcons += `<a href="${equipa.website_url}" target="_blank" class="social-icon website-icon" title="Website">
